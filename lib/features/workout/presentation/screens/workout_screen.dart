              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    AppLocalizations.of(
                      context,
                    )!.weCouldntFindAnyWorkoutDataRightNowPleaseCheckBackLater,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: RefreshIndicator(
                        ...
                        strokeWidth:
                            2.5, // Slightly thicker stroke for better visibility
                        ...
                        child: Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: ListView(
                              physics:
                                  const AlwaysScrollableScrollPhysics(), // Always allow scrolling for pull-to-refresh
                              padding: EdgeInsets.only(
                                bottom: responsiveHelper.h(20),
                              ), // Add bottom padding for better pull-to-refresh experience
                              children: [
                                if (state.allExercises.isEmpty)
                                  ...
                                  Container(
                                    ...
                                    height:
                                        ...
                                        0.6, // Ensure minimum height for pull-to-refresh
                                    padding: EdgeInsets.symmetric(
                                  ...
                                  ...state.allExercises.asMap().entries.map((
                                    entry,
                                  ) {
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          SizedBox(
                                                            ...
                                                            child: Text(
                                                              exercise
                                                                  .setsAndRepsDisplay, // Dynamic sets and reps from API
                                                              style: TextStyle(
                                                                color:
                                                                    const Color(
                                                                      0xFF848484,
      ...
      MaterialPageRoute(
        builder: (context) => SelectTypeScreen(
          ...
          onTypeSelected: (typeId, typeName) =>
              _onTypeSelected(typeId, typeName),
        ),
      ),
    );
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          // Header shimmer
          ShimmerCard(height: 80.h, padding: EdgeInsets.all(16.w)),
