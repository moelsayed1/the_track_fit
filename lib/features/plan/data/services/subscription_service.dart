...
class SubscriptionService {
  ...
  Future<Map<String, dynamic>> submitSubscription({
    ...
    try {
      log('SubscriptionService: Submitting subscription - packageId: $packageId, paymentType: $paymentType');
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        return {
          'success': false,
          'message': response.data['message'] ?? 'Failed to submit subscription',
